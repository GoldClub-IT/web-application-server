...
class HttpRequestUtilsTest {
    ...
    void splitUrlTest_good() {
        assertThat("/index.html").isEqualTo(HttpRequestUtils.extractUrl("GET /index.html"));
    }

    @Test
    void splitUrlTest_bad() {
        assertThat("/index.html").isNotEqualTo(HttpRequestUtils.extractUrl("POST /index.html"));
    }
}
